 ...
 * 
 */
@WebServiceClient(name = "UserWebServiceImplService", targetNamespace = "http://impl.WebService.base.zgc.com/", wsdlLocation = "http://localhost:8081/HMSH/webService/UWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERWEBSERVICEIMPLSERVICE_QNAME = new QName("http://impl.WebService.base.zgc.com/", "UserWebServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8081/HMSH/webService/UWS?wsdl");
    ...
    public UserWebService getUserWebServiceImplPort() {
        return super.getPort(new QName("http://impl.WebService.base.zgc.com/", "UserWebServiceImplPort"), UserWebService.class);
    }
    ...
    public UserWebService getUserWebServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://impl.WebService.base.zgc.com/", "UserWebServiceImplPort"), UserWebService.class, features);
    }
